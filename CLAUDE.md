...
- **v1.3.0 (Build 10) submitted for Apple review 2026-08-09, 1:26 PM PDT.** EAS build `cc060d02-9f23-481d-b9cd-e6a808b59b62`, EAS submission `9d858200-0236-4163-a2fe-4cfbbcbafecb`, App Store Connect review submission `96429f6d-d8fb-4fba-bc31-ef7b1f7d0cc2` (submitted by Lee Brownstein). App Privacy form updated: Product Interaction under Usage Data, purpose Analytics, not linked to user identity, not used for tracking. What's New text set. Status: **Waiting for Review** — Apple's typical turnaround has been same-day to next-day for this app (v1.2.0 took under 24 hours). Nothing further to do until Apple responds.

## Open items (as of 2026-08-09)

- **v1.3.0 is fully submitted and waiting on Apple.** Next session should check review status first (App Store Connect > SCREENBot > Distribution > 1.3.0) and update this section with the outcome — approved-and-live (add the completion timestamp, same format as the v1.2.0 record above) or rejected (record the reason and open a new fix cycle).
